...
import Label from "@/core/components/common/date/Label";
import Button from "@/core/components/common/button/Button";
import Link from "next/link";
import React, { useState } from "react";
import { EyeIcon,ChevronLeftIcon, EyeCloseIcon } from "@/core/components/icons";
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <CheckboxButton checked={isChecked} onChange={setIsChecked} />
